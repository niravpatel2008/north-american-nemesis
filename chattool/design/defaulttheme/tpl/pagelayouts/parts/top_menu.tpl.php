...
<div class='nav-list-container'>
	<div class='nav-list-div'>
		<ul class="">
			...
			<li><a href="<?php echo erLhcoreClassDesign::baseurl('chat/lists')?>" title='<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Chats list');?>' class='icon-list'></a></li>
